...
const SearchUsers = ({ user, searchUser, setSearchUser, users, setUsers }) => {
  ...
  return (
    <div className=" absolute -left-2/4 min-[400px]:-left-[100%] top-12 z-10 max-w-[300px] rounded-lg p-1 dark:shadow-dark-mode shadow-light-mode dark:bg-dark-gradient bg-light-gradient">
